...
class DataLiftModule(reactContext: ReactApplicationContext) :
     ...
     * For bare filenames, searches the app's files directory and common model subdirs.
     */
    private fun filePathFromUri(uri: String): String {
        ...
        // Bare filename — try to resolve from app directories
        resolveBundlePath(uri)?.let { return it }
        return uri
    }
     ...
     * Checks: filesDir, cacheDir, and common model subdirectories.
     */
