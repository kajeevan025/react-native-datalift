...
class DataLiftModule: NSObject, RCTBridgeModule {
    ...
    // ::: Code Generated by Copilot [b5e91f3a-7c24-4d8e-a390-6e2d1c4f8b7a]. This comment will be removed automatically after the file is saved :::
    /**
    ...
    private func filePathFromUri(_ uri: String) -> String {
        ...
        if let bundlePath = resolveBundlePath(uri) {
            return bundlePath
        }
        return uri
    }
    ...
    private func resolveBundlePath(_ filename: String) -> String? {
        ...
        for dir in subdirs {
            ...
            let filePath = (subPath as NSString).appendingPathComponent(filename)
