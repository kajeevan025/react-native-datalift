...
// ::: Code Generated by Copilot [3a7e1d4c-8f29-4b5a-9c02-6d1e3f7b8a45]. This comment will be removed automatically after the file is saved :::
// ─── Line item parser ─────────────────────────────────────────────────────────
...
export function parseLineItem(
  ...
  const numPattern = /([\$€£₹¥]\s*)?(?:(\d{1,3}(?:,\d{3})+)|(\d{1,9}))(?:\.(\d{1,4}))?\s*(%)?/g;
